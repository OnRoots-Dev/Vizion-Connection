...
export function EarlyPartnerBadge() {
    return (
        ...
        >
            ...
            <span className="relative z-[3]">Early Partner</span>
            <div className="pointer-events-none absolute inset-[2px] z-[4] rounded-[1px] border border-dashed border-[rgba(80,160,255,0.2)]" />
        </motion.div>
    );
}
