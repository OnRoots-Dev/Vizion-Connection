...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="card" className={cn("rounded-[var(--vc-radius-card)] border border-line bg-surface-1 text-ink", className)} {...props} />
}
...
function CardDescription({ className, ...props }: React.ComponentProps<"p">) {
  return <p data-slot="card-description" className={cn("text-sm text-ink-2", className)} {...props} />
}
