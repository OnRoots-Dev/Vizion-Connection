      ...
      <div className="mx-auto">
        <div className="mb-10 grid gap-8 border-b border-white/5 pb-10 lg:grid-cols-[1.2fr_1fr] lg:items-end">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <Link
              href="/register"
              className="inline-flex items-center justify-center rounded-xl px-6 py-3 font-display text-[12px] font-black uppercase tracking-[0.15em] text-black transition-opacity hover:opacity-90"
