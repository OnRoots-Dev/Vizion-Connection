...
const ROLES: RoleAction[] = [
  {
    ...
    metrics: [
      ...
      { label: "CHEERS", value: "84" },
      { label: "CONN.", value: "9" },
    ],
    description: "練習・試合・成果がプロフィールとして残り、コーチや関係者と自然に接点を持てる。",
    ctaLabel: "無料で始める",
    ctaHref: "/register",
  },
  {
  ...
  },
  {
    ...
    activityLabel: "REGION / NATIONAL",
    metrics: [
      { label: "REGIONS", value: "6" },
      { label: "PLAN", value: "ROOTS" },
      { label: "VIEW", value: "2.4K" },
    ],
    description: "活動と人物の熱量が見えるから、地域との関わりや自社の発信、スポンサー接点を自然に作れる。",
    ctaLabel: "プランを見る",
    ctaHref: "/business",
  },
];
