...
function ShareModal({ profile, onClose }: { profile: ProfileData; onClose: () => void }) {
    ...
    const cardUrl = `https://vizion-connection.jp/card/${profile.slug}`;
        ...
        >
            ...
            >
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
                    <div>
                        <p style={{ fontSize: 8, fontWeight: 900, letterSpacing: "0.22em", textTransform: "uppercase", color: "rgba(255,255,255,0.3)", margin: "0 0 4px", fontFamily: "monospace" }}>Share</p>
                        <p style={{ fontSize: 16, fontWeight: 800, color: "#fff", margin: 0 }}>プロフィールをシェア</p>
                    </div>
                    <button onClick={onClose} style={{ width: 32, height: 32, borderRadius: 99, background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.1)", color: "rgba(255,255,255,0.5)", fontSize: 16, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>×</button>
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 20 }}>
                    {SNS.map(s => (
                        <a
                            ...
                            download={s.download ? `vizion-stories-${profile.slug}.png` : undefined}
                            style={{
                        ...
                        >
                            <div style={{
                                ...
                                background: typeof s.bg === "string" ? s.bg : s.bg,
                                display: "flex", alignItems: "center", justifyContent: "center",
                            }}>
                                <svg viewBox="0 0 24 24" width={18} height={18} fill="#fff"><path d={s.icon} /></svg>
                            </div>
                            <div style={{ flex: 1 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    {[
                        ...
                        { key: "card", label: "カードページURL", value: cardUrl },
                        ...
                        <div key={key} style={{ display: "flex", alignItems: "center", gap: 8, padding: "10px 12px", borderRadius: 10, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)" }}>
                            <div style={{ flex: 1, minWidth: 0 }}>
                                <p style={{ fontSize: 9, color: "rgba(255,255,255,0.3)", margin: "0 0 2px", fontFamily: "monospace", textTransform: "uppercase", letterSpacing: "0.1em" }}>{label}</p>
                                <p style={{ fontSize: 10, color: "rgba(255,255,255,0.5)", margin: 0, fontFamily: "monospace", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{value}</p>
                            </div>
                            <button
                                onClick={() => copy(value, key)}
                                style={{
                                    flexShrink: 0, padding: "5px 10px", borderRadius: 7,
                                    background: copied === key ? `${rl}20` : "rgba(255,255,255,0.06)",
                                    border: `1px solid ${copied === key ? rl + "50" : "rgba(255,255,255,0.1)"}`,
                                    color: copied === key ? rl : "rgba(255,255,255,0.5)",
                ...
                <div style={{ marginTop: 14, display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                        ...
                        <button
                            ...
                            style={{ display: "flex", alignItems: "center", gap: 5, padding: "6px 14px", borderRadius: 8, background: `${rl}18`, border: `1px solid ${rl}40`, color: rl, fontSize: 11, fontWeight: 700, cursor: "pointer" }}>
                            <svg width={12} height={12} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
