            ...
            <div className="flex items-center justify-between gap-3 border-b px-[14px] pb-3 pt-4" style={{ borderBottomColor: t.border }}>
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        title="Notifications"
                        onClick={() => { setView("notifications"); onClose(); }}
                        className="relative flex h-9 w-9 items-center justify-center rounded-[12px] border"
                        style={{ borderColor: t.border, background: "rgba(255,255,255,0.04)", color: t.sub, cursor: "pointer" }}
                    >
                        ...
                        {notificationUnreadCount > 0 && (
                            <span
                                className="absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-[999px] px-[5px] text-[9px] font-black leading-none"
                                style={{ background: roleColor, color: "#0B0B0F" }}
                            >
                                {notificationUnreadCount > 99 ? "99+" : notificationUnreadCount}
                            </span>
                        )}
