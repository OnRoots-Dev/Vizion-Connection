...
const ROLE_BG: Record<string, string> = {
    Athlete: "#FF505012", Trainer: "#32D27812", Members: "#FFC81E12", Business: "#3C8CFF12",
};
...
const NAV = [
    {
        ...
        items: [
            {
                id: "profile", href: "/dashboard", label: "My Profile",
    ...
    },
    {
        ...
        items: [
            {
                id: "discover", href: "/discover", label: "Discovery",
...
export function Sidebar({ profile, onClose, onLogout, theme, setTheme, t, view, setView }: Props) {
    ...
    const roleBg = ROLE_BG[profile.role] ?? "#a78bfa12";
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <Link href="/dashboard" onClick={onClose} style={{ display: "block" }}>
                    <img
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                    <motion.div
                        ...
                        style={{ width: "6px", height: "6px", borderRadius: "50%", background: roleColor }}
                    />
                    <span style={{ fontSize: "8px", fontFamily: "monospace", fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", color: roleColor }}>
                        Pre‑Register
                    </span>
                </div>
            </div>
            ...
            <div style={{ padding: "10px 10px 0" }}>
                ...
                >
                    ...
                    <div style={{
                        ...
                        fontSize: "14px", fontWeight: 900, color: roleColor,
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <p style={{ fontSize: "9px", fontFamily: "monospace", color: t.sub, marginTop: "2px", opacity: 0.6 }}>
                            @{profile.slug}
                        </p>
                    </div>
                    {/* ロールバッジ */}
                    <span style={{
                        fontSize: "7px", fontWeight: 900, padding: "3px 6px", borderRadius: "4px",
                ...
                {NAV.map(({ group, items }, gi) => (
                    ...
                    >
                        <p style={{
                            ...
                            textTransform: "uppercase", color: t.sub, opacity: 0.4,
                        ...
                        {items.map(({ id, href, label, icon }) => {
                            ...
                            return (
                                <Link key={id} href={href} onClick={onClose} style={{
                                    ...
                                    <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={active ? 2.2 : 1.75}>
            ...
            <div style={{ padding: "10px", borderTop: `1px solid ${t.border}` }}>
                ...
                <p style={{
                    ...
                    textTransform: "uppercase", color: t.sub, opacity: 0.35,
                    padding: "0 8px", marginBottom: "6px", fontFamily: "monospace",
                }}>
                    Theme
                </p>
                <div style={{ display: "flex", gap: "4px", marginBottom: "10px" }}>
                    {([["dark", "🌑", "Dark"], ["dim", "🌒", "Dim"], ["light", "☀️", "Light"]] as const).map(([val, emoji, lbl]) => (
                        <button key={val} onClick={() => setTheme(val)} title={lbl} style={{
                ...
                {/* 公開プロフィール */}
                <Link href={`/u/${profile.slug}`} onClick={onClose} style={{
                    display: "flex", alignItems: "center", gap: "9px",
                    padding: "8px 10px", borderRadius: "9px",
                    color: t.sub, fontSize: "12px", marginBottom: "2px",
                ...
                {/* プロフィール編集 */}
                <button onClick={() => { setView("edit"); onClose(); }} style={{
                    display: "flex", alignItems: "center", gap: "9px",
                    padding: "8px 10px", borderRadius: "9px",
                ...
                {/* アカウント設定 */}
                <button onClick={() => { setView("settings"); onClose(); }} style={{
                    display: "flex", alignItems: "center", gap: "9px",
                    padding: "8px 10px", borderRadius: "9px",
                    border: `1px solid ${t.border}`,
                    color: t.sub, fontSize: "12px", fontWeight: 600,
                ...
                <div style={{ height: "1px", background: t.border, margin: "6px 2px" }} />
                ...
                <button onClick={onLogout} style={{
                    ...
                    color: "rgba(255,80,80,0.5)", fontSize: "12px",
