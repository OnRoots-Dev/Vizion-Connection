        ...
        const sections: NavSection[] = [
            ...
            },
            {
                ...
                items: [
                    ...
                    { type: "item", id: "roadmap", label: "Roadmap", icon: "M9 6.75V15m6-6v8.25m-6-3.75c0 1.25 1.5 1.75 2.5 1.25s1.5-1.25 1.5-2.25v-1.5m-4 0c0 1.25 1.5 1.75 2.5 1.25s1.5-1.25 1.5-2.25v-1.5M4.5 15.75V9a2.25 2.25 0 012.25-2.25h10.5A2.25 2.25 0 0120.25 9v6.75m-4.5 0V9.75a.75.75 0 00-.75-.75h-1.5a.75.75 0 00-.75.75v.75m-3 0h7.5" },
