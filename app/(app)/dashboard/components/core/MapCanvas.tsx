    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            map.on("load", () => {
                ...
                const unclustered: any = ["!", ["has", "point_count"]];
                const unclusteredCircle: any = ["all", unclustered, ["!=", ["get", "shape"], "camp"]];
                const unclusteredCamp: any = ["all", unclustered, ["==", ["get", "shape"], "camp"]];
                ...
                map.addLayer({ id: "viz-activity-pulse", type: "circle", source, filter: ["all", unclusteredCircle, ["==", ["get", "category"], "activity"]] as any, paint: { "circle-color": ["get", "pc"], "circle-radius": 14, "circle-opacity": 0.24, "circle-stroke-color": COLOR.text, "circle-stroke-width": 1, "circle-radius-transition": { duration: 1400 }, "circle-opacity-transition": { duration: 1400 } } });
