            ...
            <SectionCard t={t}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    ...
                    <a href="#" onClick={async e => { e.preventDefault(); await navigator.clipboard.writeText(referralUrl); await markShared(); alert("紹介リンクをコピーしました。Instagramのストーリーやプロフィールに貼り付けてください。"); }}
                        style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 16px", borderRadius: 12, background: "rgba(225,48,108,0.05)", border: "1px solid rgba(225,48,108,0.25)", textDecoration: "none", color: "#fff" }}>
                    ...
                    {/* LINE */}
                    <a href={`https://social-plugins.line.me/lineit/share?url=${encodeURIComponent(referralUrl)}`} target="_blank" rel="noopener noreferrer" onClick={() => { void markShared(); }}
