...
const PHASES_DATA = [
    {
        id: "early", num: "01", label: "IGNITION", status: "current" as const,
    ...
    {
        id: "v1", num: "03", label: "ASCENT", status: "future" as const,
        period: "2026年 9月予定", tagline: "広がりが、力になる。",
    ...
    {
        id: "alliance", num: "04", label: "ALLIANCE", status: "future" as const,
        period: "2027年 順次展開", tagline: "信頼が、共創を生む。",
        ...
        accent: "#28D26E", accentDim: "#28D26E20", accentBorder: "#28D26E40",
    },
    {
        id: "extra", num: "05", label: "ORIGIN", status: "future" as const,
        period: "2027年以降 順次展開", tagline: "信頼が、世界の原点になる。",
        ...
        accent: "#A855F7", accentDim: "#A855F720", accentBorder: "#A855F740",
    },
] as const;
