    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-16"
      ...
      <div className="w-full max-w-md">
          ...
          {ROLES.map((r) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="text-xs font-bold mb-0.5" style={{ color: isSelected ? r.color : "#555" }}>
                    {r.label}
                  </div>
                  <div className="text-[10px]" style={{ color: isSelected ? "rgba(255,255,255,0.5)" : "#333" }}>
                    {r.desc}
                  </div>
                </div>
              </label>
        ...
        <p className="mt-6 text-center text-xs text-white/30">
          すでにアカウントをお持ちの方は
          <Link href="/login" className="ml-1 text-white/60 hover:text-white underline">
            ログイン
          </Link>
        </p>
      </div>
